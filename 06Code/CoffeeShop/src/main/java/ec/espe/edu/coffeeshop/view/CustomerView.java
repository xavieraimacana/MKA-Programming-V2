...
public class CustomerView extends JFrame {
    ...
    public CustomerView() {
        ...
        setTitle("Gestión de Clientes - Ver Todos");
        setSize(900, 700);
        ...
        String[] columns = {"ID", "Nombre", "ID Fiscal", "Puntos de Lealtad"};
        tableModel = new DefaultTableModel(columns, 0);
        table = new JTable(tableModel);
        JPanel topPanel = new JPanel(new BorderLayout());
        topPanel.setBackground(ThemeManager.COLOR_WHITE);
        JLabel titleLabel = new JLabel("MÓDULO DE CLIENTES - SOLO LECTURA");
        ...
        btnAdd.addActionListener(e -> new CustomerAddView(this, controller).setVisible(true));
