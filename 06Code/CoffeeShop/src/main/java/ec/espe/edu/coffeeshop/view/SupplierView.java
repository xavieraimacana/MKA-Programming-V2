...
public class SupplierView extends JFrame {
    ...
    public SupplierView() {
        ...
        setTitle("Gestión de Proveedores - Ver Todos");
        setSize(900, 700);
        ...
        String[] columns = {"ID Proveedor", "Nombre de la Empresa"};
        tableModel = new DefaultTableModel(columns, 0);
        table = new JTable(tableModel);
        JPanel topPanel = new JPanel(new BorderLayout());
        topPanel.setBackground(ThemeManager.COLOR_WHITE);
        JLabel titleLabel = new JLabel("MÓDULO DE PROVEEDORES - SOLO LECTURA");
        ...
        btnAdd.addActionListener(e -> new SupplierAddView(this, controller).setVisible(true));
